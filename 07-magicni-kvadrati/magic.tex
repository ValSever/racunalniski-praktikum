...
% \begin{definicija}
   \textbf{Definicija 1. }\emph{Magični kvadrat} reda $n$ je nabor $n^2$ različnih števil,
...
\begin{table}[h!]
   \LARGE
   \centering
   \caption{Primer magičnega kvadrata reda 3 je prikazan v tabeli 1.
   }
   \label{tab:my-table}
   \begin{tabular}{lllll}
      \hline
...
% \begin{definicija}
\textbf{Definicija 2. }Magični kvadrat reda $n$ je \emph{normalen}, če v njem nastopajo števila
   \begin{equation}
      % oznaka: eq:numbers
...
\begin{center}
   Tabela 4: Dürerjev magični kvadrat 4 × 4
\end{center}
%
...
% \end{definicija}
\begin{center}
   Tabela 5: Magični kvadrat na Sagradi Famíliji
\end{center}
